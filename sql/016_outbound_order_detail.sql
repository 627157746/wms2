...
CREATE INDEX idx_outbound_order_detail_order ON outbound_order_detail(order_id);
CREATE INDEX idx_outbound_order_detail_product ON outbound_order_detail(product_id);
CREATE INDEX idx_outbound_order_detail_location ON outbound_order_detail(location_id);
